...
if "Tegoroczni" in menu:
    ...
    st.write("Ta strona służy za narzędzie do stworzenia własnego listu do Świętego Mikołaja. Po wybraniu swojego imienia pokaże się lista ktorą można swobodnie edytować - dodawać nowe pozycje lub usuwać istniejące.")
...
# Add Snow Button
if st.sidebar.button("## Wesołych Świąt! 🦌🛷☃️"):
    st.snow()
